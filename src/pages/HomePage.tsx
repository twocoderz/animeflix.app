    ...
    <div className="bg-black h-screen overflow-hidden flex items-center justify-center">
      ...
      <div className="bg-pink-500 w-[90vw] max-w-7xl h-[90vh] rounded-[40px] p-10 md:p-12 flex flex-col shadow-2xl">
        ...
        <footer className="flex flex-wrap justify-center items-center gap-5 md:gap-7 mt-8 shrink-0">
          <img
            src="/tv_logos/filmrise-anime.png"
            alt="FilmRise Anime"
            className="h-8 md:h-10 object-contain opacity-90 hover:opacity-100 transition-opacity"
          />
          <img
            src="/tv_logos/mr-bean.png"
            alt="Mr Bean"
            className="h-8 md:h-10 object-contain opacity-90 hover:opacity-100 transition-opacity"
          />
          <img
            src="/tv_logos/duck.png"
            alt="Duck"
            className="h-8 md:h-10 object-contain opacity-90 hover:opacity-100 transition-opacity"
          />
          <img
            src="/tv_logos/naruto.png"
            alt="Naruto"
            className="h-8 md:h-10 object-contain opacity-90 hover:opacity-100 transition-opacity"
          />
          <img
            src="/tv_logos/retro-crush.png"
            alt="Retro Crush"
            className="h-8 md:h-10 object-contain opacity-90 hover:opacity-100 transition-opacity"
          />
          <img
            src="/tv_logos/yu-gi-oh.png"
            alt="Yu-Gi-Oh!"
            className="h-8 md:h-10 object-contain opacity-90 hover:opacity-100 transition-opacity"
          />
          <img
            src="/tv_logos/tiny-pop.png"
            alt="Tiny Pop"
            className="h-8 md:h-10 object-contain opacity-90 hover:opacity-100 transition-opacity"
          />
          <img
            src="/tv_logos/daria.png"
            alt="Daria"
            className="h-8 md:h-10 object-contain opacity-90 hover:opacity-100 transition-opacity"
          />
          <img
            src="/tv_logos/pluto-toons.png"
            alt="Pluto Toons"
            className="h-8 md:h-10 object-contain opacity-90 hover:opacity-100 transition-opacity"
          />
          <img
            src="/tv_logos/gong.png"
            alt="Gong"
            className="h-8 md:h-10 object-contain opacity-90 hover:opacity-100 transition-opacity"
          />
        </footer>
